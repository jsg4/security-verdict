  ...
  return (
    <section id="methodology" className="bg-[var(--gray-50)] py-10">
      <div className="max-w-[var(--content-width)] mx-auto px-5">
        {/* Trust signal header */}
        <div className="bg-gradient-to-r from-[var(--primary)] to-[var(--accent)] rounded-[var(--radius-lg)] p-6 mb-8 text-white">
          <h2 className="text-2xl md:text-3xl font-extrabold mb-2">How We Test &amp; Evaluate</h2>
          <p className="text-blue-100 text-base mb-4">Our score is calculated across weighted categories, based on hands-on testing and independent research.</p>
          <div className="flex flex-wrap gap-6">
            <div className="flex items-center gap-2">
              <span className="inline-flex items-center justify-center w-10 h-10 bg-white/20 rounded-full">
                <svg viewBox="0 0 24 24" className="w-5 h-5 text-white" fill="none" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
              </span>
              <div>
                <p className="text-lg font-extrabold">200+</p>
                <p className="text-[11px] text-blue-100">Hours of Testing</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <span className="inline-flex items-center justify-center w-10 h-10 bg-white/20 rounded-full">
              ...
              <div>
                <p className="text-lg font-extrabold">{config.products.length}+</p>
                <p className="text-[11px] text-blue-100">Products Evaluated</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <span className="inline-flex items-center justify-center w-10 h-10 bg-white/20 rounded-full">
              ...
              <div>
                <p className="text-lg font-extrabold">{config.scoringCriteria.length}</p>
                <p className="text-[11px] text-blue-100">Scoring Criteria</p>
              </div>
            </div>
          </div>
        </div>
