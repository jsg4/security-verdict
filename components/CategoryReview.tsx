  ...
  return (
    <div className={`mb-10 ${isTopPick ? "ring-2 ring-[var(--gold)]" : ""}`} id={product.slug}>
      ...
      <a
        ...
        className={`block border border-gray-200 bg-white shadow-sm hover:shadow-lg transition-all no-underline text-inherit ${isTopPick ? "rounded-b-xl" : "rounded-xl"} overflow-hidden`}
      >
        {/* Header */}
