...
export default function StickyMobileCTA({ product }: { product: Product }) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-white border-t border-gray-200 shadow-[0_-4px_12px_rgba(0,0,0,0.1)] px-5 py-3 animate-slide-up">
