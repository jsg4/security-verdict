      ...
      <div className="max-w-[var(--content-width)] mx-auto px-5">
        ...
        <div className="grid grid-cols-2 md:flex md:flex-wrap gap-2">
          {config.heroBadges.map((badge) => (
            <span key={badge} className="inline-flex items-center gap-1 px-2 py-1.5 md:gap-1.5 md:px-3 bg-white border border-[var(--gray-200)] rounded-[var(--radius-full)] text-[11px] md:text-[12px] font-medium text-[var(--gray-700)] shadow-sm whitespace-nowrap">
